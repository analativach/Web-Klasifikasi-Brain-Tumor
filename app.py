...
def predict_label(img_path):
    ...
    diagnosis_explanations = {
        ...
        'notumor': 'Tidak terdeteksi adanya tumor otak. Namun, konsultasikan dengan dokter untuk pemeriksaan lanjutan jika Anda memiliki gejala.',
    ...
    return(
        f"Anda Menderita: {class_name} <br> (Probabilitas Diagnosa : {predictions[class_idx] * 100:.2f}%) <br> Penjelasan: {explanation} <br> Peringatan! AI ini bisa saja salah, jangan jadikan hasilnya sebagai diagnosa utama!"
        )
